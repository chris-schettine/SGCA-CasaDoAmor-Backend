...
import br.com.casadoamor.sgca.modules.auth.repository.AuthUsuarioDadosPessoaisRepository;
import br.com.casadoamor.sgca.modules.auth.repository.AuthUsuarioEnderecoRepository;
import br.com.casadoamor.sgca.modules.auth.repository.AuthUsuarioRegistroProfissionalRepository;
...
public class UserManagementService {
    ...
    String searchPlain = searchText.toLowerCase();
        ...
        org.springframework.data.jpa.domain.Specification<br.com.casadoamor.sgca.modules.auth.entity.AuthUsuario> spec = (root, query, cb) -> {
     ...
     */
    private AuthUsuarioRegistroProfissional criarRegistroProfissional(AuthUsuario usuario, br.com.casadoamor.sgca.modules.auth.dtos.RegistroProfissionalDTO dto, AuthUsuario admin) {
